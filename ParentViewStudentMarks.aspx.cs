...
public partial class ParentViewStudentMarks : System.Web.UI.Page
{
    SqlConnection con;
    SqlDataAdapter adp;
    DataTable dt;
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                adp = new SqlDataAdapter("select * from semetable where regno=@regno ", con);
            ...
            else
            {
                ...
                adp = new SqlDataAdapter("select * from semetable where regno=@regno and semester=@semester", con);
                adp.SelectCommand.Parameters.AddWithValue("regno", TextBox1.Text);
